...
COLOR_THEME = {
    ...
    "B": "death and decay, dark purple and black palette, gloomy, shadowy, undead",
    "G": "nature and growth, green and brown palette, lush, vibrant, organic, forestry",
...
MANUAL_MOTIF = {
    ...
    # 黒
    "shiki": "necromancer dark wizard, black robes, skull staff, death aura",
    "ren": "zombie warrior undead, rotting flesh, cursed aura",
    "yami_jouhouya": "assassin in shadow, dark silhouette, menacing",
    "skeleton_senshi": "skeleton warrior bones, martial stance, eerie glow",
    "itazura_obake": "mischievous ghost spirit, translucent, floating",
    "haka_zombie": "gravekeeper zombie, tattered robes, grave dirt",
    "taisei_zombie": "resilient undead creature, stubborn stance",
    "hakaatsume_yatoware": "grave robber assassin, sneaky dark figure",
    "shigoeki": "death magic beam, dark void energy",
    "kurogeki": "black destruction spell, shadow blast",
    # 緑
    "foklya": "ancient tree spirit elf maiden, forest crowned, nature aura",
    "tami_kaitaku": "settler pioneer, lush green field, farming",
    "folkusu": "forest tree folk creature, wooden body, rooted",
    "kaitakusha": "new adventurer explorer, jungle clearing, nature guide",
    "mori_kansha": "forest gratitude ritual, green magic, glowing nature",
    "gen_jurei": "ancient tree spirit, old bark, magical roots",
    "mori_tami": "forest people guardian, leafy garments, wild nature",
    "iwai_tami": "festival celebrant, festive nature joy, flowers",
    "matsuri_otoko": "festival man, celebration, natural energy",
    "kaitaku_miko": "shrine maiden pioneer, lantern, forest clearing",
    "hito_mori": "inhabited lush forest, village hidden in trees",
    "wasure_mori": "forgotten overgrown forest, nature reclaiming",
    "shigen_mori": "resource-rich forest, abundant timber, green wealth",
    "kemono_mori": "wild forest creature habitat, dangerous beasts",
    "matsuri_kaijo": "festival gathering place, celebration grounds, nature celebration",
    # 土地
